...
MY_PC_SRC_URL='http://10.20.134.222/images/pc-5.7.1-stable-prism_central.tar.gz'
#MY_PC_META_URL='http://10.21.250.221/images/ahv/techsummit/euphrates-5.6-stable-prism_central_metadata.json'
MY_PC_META_URL='http://10.20.134.222/images/pc-5.7.1-stable-prism_central_metadata.json'
...
#ncli cluster edit-params external-ip-address=10.20.${MY_HPOC_NUMBER}.37
# Set Data Services IP address:
my_log "Set Data Services IP address to 10.20.${MY_HPOC_NUMBER}.38"
ncli cluster edit-params external-data-services-ip-address=10.20.${MY_HPOC_NUMBER}.38
# Importing images
MY_IMAGE="AutoDC"
retries=1
...
root@10.20.${MY_HPOC_NUMBER}.40 "samba-tool dns zonecreate dc1 ${MY_HPOC_NUMBER}.21.10.in-addr.arpa; service samba-ad-dc restart"
